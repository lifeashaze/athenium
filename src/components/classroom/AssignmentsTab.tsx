      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {sortedActiveAssignments.length === 0 && userRole === 'STUDENT' && (
            <div className="col-span-full flex flex-col items-center justify-center p-8 text-center border-2 border-dashed rounded-lg bg-background">
          ...
          {sortedActiveAssignments.map((assignment) => (
            <Card key={assignment.id} className="relative group hover:shadow-lg transition-all duration-300 hover:bg-accent/50">
              <CardContent className="p-6 h-[300px] flex flex-col justify-between">
                {/* Content Section */}
                <div>
                  {/* Header */}
      ...
      {(sortedOverdueAssignments.length > 0 || userRole === 'STUDENT') && (
        <div>
          ...
          {sortedOverdueAssignments.length === 0 ? (
            <div className="flex flex-col items-center justify-center p-8 text-center border-2 border-dashed rounded-lg bg-card">
              <FolderOpen className="h-12 w-12 text-muted-foreground mb-4" />

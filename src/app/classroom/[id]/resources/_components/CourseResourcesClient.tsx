...
import { Book, FileText, FileSpreadsheet, FileImage, File, ChevronRight, Upload, Trash2, ChevronDown, Search, Download, FolderOpen } from 'lucide-react'
...
const DocumentChat = dynamic(() => import('@/components/classroom/DocumentChat'), {
  ssr: false,
  loading: () => (
